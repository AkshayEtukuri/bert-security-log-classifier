...
📝 **Blog post:** [akshayetukuri.hashnode.dev/fine-tuning-bert-to-classify-security-logs-and-the-100-accuracy-trap-i-fell-into](https://akshayetukuri.hashnode.dev/fine-tuning-bert-to-classify-security-logs-and-the-100-accuracy-trap-i-fell-into)
